...
public class CubeDataTests : TestWithLoggingBase
{
    ...
    public class Bool16CubeDataTests(ITestOutputHelper output)  : CubeDataTestsBase<CubeDataBuffer16>(output);
    ...
    public class BoolUnequalLongZCubeDataTests(ITestOutputHelper output) : CubeDataTestsBase<CubeDataBuffer66x42x12>(output);
}