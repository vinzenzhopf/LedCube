...
public struct CubeDataBuffer4x7x35 : ICubeDataBuffer<CubeDataBuffer4x7x35>
{
    private bool _element0;
    
    private const int DimensionX = 4;
    private const int DimensionY = 7;
    private const int DimensionZ = 35;
    public static Span<bool> GetBuffer(ref CubeDataBuffer4x7x35 self) => self;
    public static ReadOnlySpan<bool> GetReadOnlyBuffer(in CubeDataBuffer4x7x35 self) => self;
