...
public struct CubeDataBuffer66x42x12 : ICubeDataBuffer<CubeDataBuffer66x42x12>
{
    private bool _element0;
    
    private const int DimensionX = 66;
    private const int DimensionY = 42;
    private const int DimensionZ = 12;
    public static Span<bool> GetBuffer(ref CubeDataBuffer66x42x12 self) => self;
    public static ReadOnlySpan<bool> GetReadOnlyBuffer(in CubeDataBuffer66x42x12 self) => self;
