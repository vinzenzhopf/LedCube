...
public struct CubeDataBuffer8 : ICubeDataBuffer<CubeDataBuffer8>
{
    private bool _element0;
    
    private const int Dimension = 8;
    public static Span<bool> GetBuffer(ref CubeDataBuffer8 self) => self;
    public static ReadOnlySpan<bool> GetReadOnlyBuffer(in CubeDataBuffer8 self) => self;
